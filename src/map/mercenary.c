...
int read_mercenarydb(void)
{
	...
	fclose(fp);
	ShowStatus("Leitura de '"CL_WHITE"%d"CL_RESET"' mercenarios em '"CL_WHITE"db/mercenary_db.txt"CL_RESET"' concluida.\n",j);
...
int read_mercenary_skilldb(void)
{
	...
	fclose(fp);
	ShowStatus("Leitura de '"CL_WHITE"%d"CL_RESET"' entradas em '"CL_WHITE"db/mercenary_skill_db.txt"CL_RESET"' concluida.\n",j);
	return 0;
}
